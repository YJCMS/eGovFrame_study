...
// 			$.extend(param, {"lastNm" : $("#search").find('[name="lastNm"]').val() , "firstNm" : $("#search").find('[name="firstNm"]').val()});
    	...
    	function selectList() {
    		...
    		var url = "/aaaa/moon/selectSampleDataList1_mapper.do"
...
//     		$("#dataList").find("tbody").empty();
		...
		function insertData(){
			...
			var url = "/aaaa/moon/insertData_mapper.do"
...
//    			  async: false,
    	...
    	function updateData(){
			...
			var url = "/aaaa/moon/updateData_mapper.do"
    	...
    	function deleteData(){
			...
			var url = "/aaaa/moon/deleteData_mapper.do"
    	...
    	function deleteYnData(){
			...
			var url = "/aaaa/moon/deleteYnData_mapper.do"
...
<body style="text-align:center; margin:0 auto; display:inline; padding-top:100px;">
	<div style="width: 100%;height: 50px;">
		<span style="font-weight: bold;color: blue;">studyPageMapper.jsp 화면 -- mybatis 활용( 기존 DAO 형태로 사용하는 경우 )</span>
	</div>
	<br/>
